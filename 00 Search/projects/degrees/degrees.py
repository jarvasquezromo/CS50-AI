...
def shortest_path(source, target):
    ...
    # Guarda el numero de estados explorados
    num_explored = 0

    # Inicializando el frontier con la posicion inicial
    start = Node (state=source, parent=None, action=None)
    frontier = QueueFrontier ()
    frontier.add (start)
    # Nuestro frontier debe ser del tipo fila para tener un stack del tipo FIFO y 
    # poder realizar una busqueda BFS (breadth-first-search)

    # Iniciando set vacio explorado
    explored = set ()
